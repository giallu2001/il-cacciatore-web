    ...
    <main className="min-h-screen bg-[#F5F0E8] text-[#1A1C18]">
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="rounded-3xl border border-[#DDD4C0] bg-[#FDFAF5] p-10 shadow-xl">
          ...
          <h1 className="font-display mt-6 text-5xl font-black">Meteo e Orari</h1>
          <p className="mt-4 max-w-2xl text-lg leading-8 text-[#3D3F38]">Alba, tramonto, fasi lunari, vento e pressione per comune.</p>
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            ...
            <button className="rounded-xl bg-[#2D4A22] px-5 py-3 font-bold text-white">Calcola orari</button>
          </div>
